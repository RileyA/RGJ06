...
namespace RGJ
{
	...
	void MenuState::init()
	{
		...
		StaticText* txt = new StaticText(scrn->getRootElement(0),"Title",0,20,
			Vector2(0.3f,0.15f),Vector2(0.4,1.f/20.f),"Reticulated Spline");
		txt->setColour(Colour(1.f,1.f,1.f));
		txt->setAlign(GA_CENTER);

		txt = new StaticText(scrn->getRootElement(0),"Subtitle",0,20,Vector2(0.2f,0.21f),Vector2(0.6,1.f/20.f),"A 48hr Reddit Game Jam #6 Game");
		txt->setColour(Colour(1.f,1.f,1.f));
		txt->setAlign(GA_CENTER);
		...
		txt = new StaticText(scrn->getRootElement(0),"Instr",0,20,Vector2(0.05f,0.4f),Vector2(1.f,1.f/20.f),"Instructions: ");
		txt = new StaticText(scrn->getRootElement(0),"Instr",0,20,Vector2(0.1f,0.45f),Vector2(1.f,1.f/20.f),"Avoid lasers, keep your energy bar in balance.");

		txt = new StaticText(scrn->getRootElement(0),"Controls",0,20,Vector2(0.05f,0.5f),Vector2(1.f,1.f/20.f),"Controls: ");
		txt = new StaticText(scrn->getRootElement(0),"Controls",0,20,Vector2(0.1f,0.55f),Vector2(1.f,1.f/20.f),"Mouse - Move");
